...
Oppia is an online learning tool that enables anyone to easily create and share interactive activities (called 'explorations'). These activities simulate a one-on-onconversation with a tutor, enabling students to learn by doing while getting feedback.
